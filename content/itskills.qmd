...
Als primäre Programmiersprache wird bisher die funktionale Programmiersprache R verwendet, erste Einblicke in Python wurden ebenfalls erlangt. Meine Fähigkeiten bündeln sich um die Datenaufbereitung, -analyse und -visualisierung. Mithilfe des [Quarto-Frameworks](https://quarto.org) setze ich Projekte um und dokumentiere diese.
